param(
    [string]$ExePath = (Join-Path $PSScriptRoot "..\publish\OsuCursorWin.exe"),
    [string]$InstallDir = "C:\Program Files\OsuCursorWin"
)
...
$destExe = Join-Path $InstallDir "OsuCursorWin.exe"
