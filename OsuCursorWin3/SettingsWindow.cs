...
internal sealed class SettingsWindow : Window
{
    ...
    private FrameworkElement BuildSliderWithTextBox(string label, double value, double sliderMin, double sliderMax, Action<double> apply, double step = 1.0, string format = "0.##", double? textMin = null, double? textMax = null)
    {
        ...
        var minusBtn = new Button { Content = "−", Width = 32, Height = 32, FontSize = 16, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(2, 0, 1, 0) };
        var plusBtn = new Button { Content = "+", Width = 32, Height = 32, FontSize = 16, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(1, 0, 2, 0) };
